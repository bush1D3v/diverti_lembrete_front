            ...
            <CommandList>
                ...
                <CommandGroup heading="Sugestões" v-if="inputValue.length === 0">
                    <CommandItem
                        value="Criar"
                        to="/reminders/create"
                        @click="saveToLocalStorage('Criar')"
                    >
                        <PlusIcon class="mr-2 h-4 w-4 text-light" />
                        <span class="text-light">Criar</span>
                    </CommandItem>
                    <CommandItem
                        value="Seus Lembretes"
                        to="/reminders"
                        @click="saveToLocalStorage('Seus Lembretes')"
                    >
                ...
                <CommandGroup heading="Recomendado" v-if="inputValue.length > 0">
                    <CommandItem
                        value="Configurações"
                        to="/settings"
                        @click="saveToLocalStorage('Configurações')"
                    >
                    ...
                    <CommandItem
                        ...
                        to="/"
                        @click="saveToLocalStorage('Página Inicial')"
                    >
                    ...
                    <CommandItem
                        value="Gráficos"
                        to="/graphs"
                        @click="saveToLocalStorage('Gráficos')"
                    >
                    ...
                    <CommandItem
                        value="Raiva"
                        to="/reminders/angry?page=1"
                        @click="saveToLocalStorage('Raiva')"
                    >
                    ...
                    <CommandItem
                        value="Tristeza"
                        to="/reminders/sad?page=1"
                        @click="saveToLocalStorage('Tristeza')"
                    >
                    ...
                    <CommandItem
                        value="Inveja"
                        to="/reminders/envy?page=1"
                        @click="saveToLocalStorage('Inveja')"
                    >
                    ...
                    <CommandItem
                        value="Nojinho"
                        to="/reminders/disgust?page=1"
                        @click="saveToLocalStorage('Nojinho')"
                    >
                    ...
                    <CommandItem
                        value="Tédio"
                        to="/reminders/boredom?page=1"
                        @click="saveToLocalStorage('Tédio')"
                    >
                    ...
                    <CommandItem
                        value="Medo"
                        to="/reminders/fear?page=1"
                        @click="saveToLocalStorage('Medo')"
                    >
                    ...
                    <CommandItem
                        value="Vergonha"
                        to="/reminders/shame?page=1"
                        @click="saveToLocalStorage('Vergonha')"
                    >
